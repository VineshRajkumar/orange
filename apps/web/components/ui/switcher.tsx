...
const Switcher11 = () => {
  ...
  return (
    <div className='themeSwitcherTwo shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-white dark:bg-black p-1'>

      <button
        type='button'
        onClick={() => setTheme("light")}
        className={`flex items-center space-x-[6px] rounded py-2 px-2 md:px-[18px] text-sm font-medium transition-all duration-200 ${!isDark
            ? "bg-[#FF7F00] text-white dark:bg-[#FFA040] dark:text-white"
