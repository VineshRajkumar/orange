...
import { EyeIcon, Heart, Sparkles, Star } from 'lucide-react'
import { cn } from '@/lib/utils'
import * as homepageActions from '@/actions/homepage-action'
    ...
    return (
        <Dialog modal={false} >
            <DialogTrigger asChild>
                <Button variant="outline" size="icon" className=" border-0 shadow-none hover:text-primary ">
            ...
            <DialogContent className="w-[240px] rounded-xl p-4 border border-muted bg-background" overlayClasses="fixed inset-0 z-50 bg-black/50 backdrop-blur-[1px]  transition-opacity animate-fade-in">
                ...
                <div className="flex flex-col space-y-3 text-muted-foreground">
                    ...
                    {/* star */}
                    <Link
                        href="https://github.com/VineshRajkumar/orange.git"
                        target="_blank"
